...
enum { PORT_SRVPING, PORT_LISTCID, PORT_PEERPING, PORT_PEERLATREP, MAXSPECIALPORT };
...
size_t packmsg(char* destbuf, size_t maxlen, secret_t secret,
               callerid_t callerid, uint32_t destport, const char* msg,
               size_t msglen);
size_t unpackmsg(const char* srcbuf, size_t len, secret_t& secret,
